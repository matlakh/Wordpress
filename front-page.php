    ...
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="<?php bloginfo("template_url"); ?>/assets/img/carousel-1.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="<?php bloginfo("template_url"); ?>/assets/img/carousel-2.jpg" alt="Image">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h4 class="text-white text-uppercase mb-md-3">Traditional & Delicious</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-4" style="min-height: 400px;">
                <div class="position-relative h-100 rounded overflow-hidden">
                    <img class="position-absolute w-100 h-100" src="<?php bloginfo("template_url"); ?>/assets/img/about.jpg" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-4 py-5">
    ...
    <div class="row bg-primary m-0">
        <div class="col-md-6 px-0" style="min-height: 500px;">
            <div class="position-relative h-100">
                <img class="position-absolute w-100 h-100" src="<?php bloginfo("template_url"); ?>/assets/img/promotion.jpg" style="object-fit: cover;">
